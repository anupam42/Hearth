...
export const icons = {
  ...
  alertCircle: (size?: number) =>
    icon(`<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="13"/><line x1="12" y1="16" x2="12" y2="16.01"/>`, size),
  ...
  compass: (size?: number) =>
    icon(`<circle cx="12" cy="12" r="10"/><polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"/>`, size),
